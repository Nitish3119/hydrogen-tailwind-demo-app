...
export default function ProductHandle() {
  ...
  return (
    <section className="w-full gap-4 md:gap-8 grid px-6 md:px-8 lg:px-12">
      <br/>
      <div className="grid items-start gap-2 lg:gap-20 md:grid-cols-2 lg:grid-cols-3" style = {{textAlign: 'left', maxWidth: '40%', float: 'right'}}>
        <div className="md:sticky md:mx-auto max-w-xl md:max-w-[24rem] grid gap-8 p-0 md:p-6 md:px-0 top-[6rem] lg:top-[8rem] xl:top-[10rem]" style = {{margin: '20px'}} >
          ...
          />
          <br/>
          <strike>${selectedVariant.price.amount*2 }</strike> <span style ={{color: 'red'}}>50% OFF</span>
          <Money
          ...
          <h3 style = {{marginBottom: '-0.5%'}}>Poduct Description</h3>
          <div
      ...
      <div className="grid md:grid-flow-row  md:p-0 md:overflow-x-hidden md:grid-cols-2 md:w-full lg:col-span-2" style = {{float: 'left'}}>
      ...
      {media.map((med, i) => {
        ...
        return (
          <div
            ...
            style = {{width: '750px', marginLeft: '7px'}}
          >
            <MediaFile
              tabIndex="0"
              className={`w-full h-full aspect-square object-cover`}
              data={data}
              style={{height: '320px', width: '350px', borderRadius: '5%', marginTop: '3px', float: 'left', padding: '10px'}}
              {...extraProps}
            />
          </div>
        );
